...
$ Package structure
    ...
    │   ├── user manual
    │   │   └── FYP Descriptions Generator User Manual.pdf
    │   ├── input file
    │   │   └── project_description.csv
    │   └── output file
    │       ├── CS_Projects_2022.pdf
    │       └── Project_Descriptions_Computer_Science_2022.pdf
    ├── README.txt
    ...
    └── src
        ...
        │   │       └── PdfService.java
        │   └── resources
        │       ├── font -------------------- Stores the font files for compiling PDF
        │       │   └── Wingdings.ttf
